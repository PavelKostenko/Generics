...
package com.kostenko.generics.e12;
...
public class New {
    ...
    public static void printM(Map<MyBeautifulClass, MySuperBeautifulClass> m){
        m.put(new MyBeautifulClass(88), new MySuperBeautifulClass(99));
    ...
    public static void main(String[] args) {
        ...
        System.out.println("**************");
        printM(New.map());
        printM(New.<MyBeautifulClass, MySuperBeautifulClass>map());
